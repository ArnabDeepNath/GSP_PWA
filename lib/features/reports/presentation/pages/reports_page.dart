...
import 'package:gstsync/features/reports/domain/models/filed_report.dart';
import 'package:gstsync/features/reports/domain/models/report_type.dart';
import 'package:gstsync/features/reports/presentation/bloc/reports_bloc.dart';
import 'package:gstsync/features/reports/presentation/pages/report_filing_page.dart';
...
class _ReportsPageState extends State<ReportsPage>
  ...
  void _handleTabSelection() {
    if (_tabController.indexIsChanging) {
      ...
      // When tab changes, we filter the reports in the builder method
      // leveraging the existing state
    }
  }
                  ...
                  builder: (context, state) {
                    if (state is ReportsLoading) {
                      ...
                      final filteredReports =
                          _applyFilters(typeFilteredReports);
