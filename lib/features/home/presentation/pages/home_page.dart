...
import 'package:gstsync/features/item/presentation/pages/item_list_page_updated.dart';
import 'package:gstsync/features/party/presentation/bloc/party_bloc.dart';
import 'package:gstsync/features/party/presentation/pages/party_list_page.dart';
import 'package:gstsync/features/invoice/presentation/pages/invoice_list_page.dart';
import 'package:gstsync/features/party/presentation/pages/add_edit_party_page.dart';
import 'package:gstsync/features/invoice/presentation/pages/add_edit_invoice_page.dart';
import 'package:gstsync/features/invoice/presentation/pages/create_invoice_page.dart';
import 'package:gstsync/features/profile/presentation/pages/profile_page.dart';
import 'package:gstsync/features/reports/presentation/pages/reports_page.dart';
import 'package:gstsync/features/item/presentation/pages/add_edit_item_page.dart';
import 'package:gstsync/features/store/presentation/providers/store_provider.dart';
import 'package:gstsync/features/store/presentation/widgets/drawer_store_selector.dart';
  ...
  Future<bool> _requestStoragePermission() async {
    if (Platform.isAndroid) {
      ...
      if (androidInfo.version.sdkInt >= 33) {
        // Android 13+: No permission needed for file picker (uses scoped storage)
        // The file_picker plugin handles system file picker automatically
        return true;
      } else if (androidInfo.version.sdkInt >= 30) {
        // Android 11-12: No permission needed for file picker (uses scoped storage)
        // The file_picker plugin handles system file picker automatically
        return true;
      } else if (androidInfo.version.sdkInt >= 29) {
        // Android 10: Scoped storage is default, no permission needed for file picker
        return true;
      } else {
